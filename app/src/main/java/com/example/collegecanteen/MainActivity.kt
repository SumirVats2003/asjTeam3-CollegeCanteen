...
import com.example.collegecanteen.databinding.ActivityMainBinding
...
//        Reference
        val Login=findViewById<Button>(R.id.buttonotp)


        var currentUser = auth.currentUser
        if(currentUser != null) {
            startActivity(Intent(applicationContext, otp_page::class.java))
            finish()
        }
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onCodeSent(
                ...
                var intent = Intent(applicationContext,otp_page::class.java)
    ...
    private fun login() {
        val mobileNumber=findViewById<EditText>(R.id.editTextNumber)
